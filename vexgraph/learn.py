...
BEGINNER: tuple[Exercise, ...] = (
    ...
    Exercise(
        ...
        steps=(
            ...
            "2. Tab, type set component, Enter. The node that appears is "
            "called Set Attribute Component, and it writes ONE part of a "
            "vector attribute - exactly what you need.\n"
    ...
    Exercise(
        ...
        steps=(
            ...
            "odd ones leave 1.\n"
            "3. Tab, equal - the node is called Is Equal To. Wire the "
            "Remainder's Result into a and leave b as 0. Now you have a "
            "true/false answer.\n"
    ...
    Exercise(
        ...
        steps=(
            ...
            "the distance.\n"
            "3. Tab, fit - the node is called Fit Range. Value from the "
            "length, Old Min 0, Old Max 2, and now the trick: New Min 1, "
            "New Max 0. Backwards on purpose, so near means big.\n"
